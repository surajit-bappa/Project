...
|
*/
	define('FILE_UPLOAD_BASE_PATH', '/var/www/html/Project/'); 
	define('IMAGE_URL', 'http://localhost/Project/');
	define('ASSETS_URL', "http://localhost/Project/assets/");
	$config['base_url']			= "http://localhost/Project/";
	$config['front_base_url']		= "http://localhost/Project/admin"; 
	$config['server_absolute_path'] 	= "/var/www/Project/admin"; 
	$config['file_upload_absolute_path']    = "/var/www/Project/admin";
	$config['file_upload_base_url'] 	= $config['front_base_url']."upload/";
	$config['css_images_js_base_url']	= "http://localhost/Project/assets/public/";
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
